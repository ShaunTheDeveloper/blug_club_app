...
class AppDatabase {
  ...
  static List<OnBoardingData> get onBoarding{
    List<OnBoardingData> list =[];
    for(int i=0;i<4;i++){
      list.add(OnBoardingData('Read the article you want Instantly', 'you can read thousands of articles on Blog club  save them in the application and share them with your loved ones.'));
